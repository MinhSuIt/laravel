    ...
    <div class="login-box-body">
        ...
        <form method="post" action="{{ url('/login') }}">
            ...
            <div class="form-group has-feedback {{ $errors->has('email') ? ' has-error' : '' }}">
                <input value="su@gmail.com" type="email" class="form-control" name="email" value="{{ old('email') }}" placeholder="@lang('auth.email')">
            ...
            <div class="form-group has-feedback{{ $errors->has('password') ? ' has-error' : '' }}">
                <input value="su@gmail.com" type="password" class="form-control" placeholder="@lang('auth.password')" name="password">
