...
<div class="form-group col-sm-6">
    ...
    <img style="width:140px" src="{{ asset('storage/'.$category->image) }}" alt="">
    ...
    <div class="tab-content" id="myTabContent">
        ...
        @foreach ($languages as $language)
            ...
            <div class="tab-pane fade{{$active}}" id="{{$language->code}}" role="tabpanel" aria-labelledby="{{$language->code}}-tab">
                    ...
                    {!! Form::text($language->code.'[meta_title]', $translate && $translate->name ? $translate->meta_title :'', ['class' => 'form-control']) !!}
                    
                    {!! Form::label($language->code.'[meta_description]', 'Meta description') !!}
                    {!! Form::text($language->code.'[meta_description]', $translate && $translate->name ? $translate->meta_description :'', ['class' => 'form-control']) !!}
            </div>
            </li>
        @endforeach
